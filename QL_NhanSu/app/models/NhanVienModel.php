...
class NhanVienModel
{
    ...
    public function addNhanVien($ten, $phai, $noiSinh, $luong, $maPhongBan)
    {
        $errors = [];
        ...
        $query = "INSERT INTO " . $this->table_name . " (Ten_NV, Phai, Noi_Sinh, Luong, Ma_Phong) VALUES (:ten, :phai, :noiSinh, :luong, :maPhongBan)";
        $stmt = $this->conn->prepare($query);
